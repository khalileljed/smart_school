...
namespace SchoolManagment3.DAL
{
    class DataAccessLayer
    {
        ...
        public static string con = @"Data Source=DESKTOP-1TE5FKC;Initial Catalog=ISETManagment;Integrated Security=True";
        //public static string con = $@"{stri}; Initial Catalog=ISETManagment; User Id = khalil";
